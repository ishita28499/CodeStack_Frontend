...
export const SideBarWidgetData = [
  ...
  },
  {
    ...
    icon: <div className="favicon favicon-stackexchangemeta" title="Meta Code Stack "/>,
    link: 'https://meta.stackexchange.com/questions/376530/what-goes-into-site-sponsorships-on-se'
  },
  {
    type: 'item',
    title: 'Code Stack Q&amp;A access will not be restricted in Russia',
    icon: <div className="favicon favicon-stackexchangemeta" title="Meta Code Stack"/>,
  ...
  },
  {
    ...
    icon: <div className="favicon favicon-stackoverflowmeta" title="Meta Code Stack"/>,
